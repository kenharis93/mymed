package com.kenharis.mymed4.security;
...
public class JwtTokenFilter extends GenericFilterBean {
    ...
    private MyMedUserDetailsService userDetailsService;

    public JwtTokenFilter(MyMedUserDetailsService userDetailsService) {
